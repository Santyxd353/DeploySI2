...
class _UploadPrescriptionPageState extends State<UploadPrescriptionPage> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    try {
      ...
      setState(
        () =>
            _error = 'No se pudo cargar la imagen de la receta. Detalle: $exc',
      );
    } finally {
              ...
              child: Column(
                children: [
                  _ActionCardButton(
                    ...
                    title: 'Tomar foto',
                    subtitle:
                        'Abre la cámara del teléfono y captura la receta.',
                  ...
                  _ActionCardButton(
                    ...
                    subtitle:
                        'Selecciona una imagen ya guardada en el dispositivo.',
